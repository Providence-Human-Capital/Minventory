            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('savedispense') }}" class="container">
                        ...
                        @if ($employee)
                            <div class="row mb-3">
                                UIN:<input type="text" name="UIN" id="UIN"value="{{ $employee->uin }}"
                                    style="border: none" readonly></input>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <label>Phone Number: {{ $employee->country_code }}
                                        {{ $employee->phone_number }}</label><br>
                                    <label>Employed at: {{ $employee->employeer }}</label><br>

                                    <label for="checkbox">Are you a dependant?:</label>
                                    <input type="checkbox" id="checkbox" name="checkbox"
                                        onclick="dependantFunction()"><br>
                                </div>
